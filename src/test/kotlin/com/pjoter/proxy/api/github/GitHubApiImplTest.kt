...
class GitHubApiImplTest {
    ...
    @Test
    fun `Given 404 NOT FOUND response When fetching repository by username Then should return null`() =
        runTest {
            // Given
            val page = 1
            val perPage = 2
    ...
    @Test
    fun `Given 401 UAUTHORIZED response When fetching repository by username Then should return null`() =
        runTest {
            // Given
            val page = 1
            val perPage = 2
    ...
    // TODO same would be done for the second endpoint
}
